...
def show_toast():
    ...
    # 알림 창 배경색 설정
    alert_window.config(bg="black")

    # 알림 텍스트 레이블
    label = ctk.CTkLabel(alert_window, text="스트레칭 해", font=("Arial", 16), text_color="black", bg_color="white")
    label.pack(pady=20)

    # 확인 버튼
    ok_button = ctk.CTkButton(alert_window, text="확인", command=alert_window.destroy, width=120, height=40, 
                              corner_radius=10, fg_color="green", hover_color="lightgreen")
